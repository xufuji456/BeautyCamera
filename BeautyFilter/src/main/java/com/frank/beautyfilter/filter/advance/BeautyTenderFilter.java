...
/**
 * @author xufulong
 * @date 2022/6/25 6:41 下午
 * @desc
 */
public class BeautyTenderFilter extends GPUImageFilter {
    ...
    public BeautyTenderFilter() {
        super(NORMAL_VERTEX_SHADER, OpenGLUtil.readShaderFromSource(R.raw.tender));
    }
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = OpenGLUtil.loadTexture(BeautyParams.context, "filter/bluevintage_mask1.jpg");
            }
        });
    }
