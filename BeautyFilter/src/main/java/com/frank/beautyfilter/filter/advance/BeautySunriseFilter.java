...
public class BeautySunriseFilter extends GPUImageFilter {
    ...
    protected void onInit() {
        ...
        mMaskGrey1UniformLocation = GLES30.glGetUniformLocation(getProgramId(), "grey1Frame");
        mMaskGrey2UniformLocation = GLES30.glGetUniformLocation(getProgramId(), "grey2Frame");
        mMaskGrey3UniformLocation = GLES30.glGetUniformLocation(getProgramId(), "grey3Frame");
    }
