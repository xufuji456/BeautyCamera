...
/**
 * @author xufulong
 * @date 2022/6/22 10:12 上午
 * @desc
 */
public class BeautySunriseFilter extends GPUImageFilter {
    ...
    private final int[] mToneCurveTexture = {-1};
    private int mToneCurveTextureUniformLocation;

    public BeautySunriseFilter() {
        super(NORMAL_VERTEX_SHADER, OpenGLUtil.readShaderFromSource(R.raw.sunrise));
    }
    ...
    protected void onInit() {
        ...
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(getProgramId(), "grey1Frame");
        mMaskGrey2UniformLocation = GLES20.glGetUniformLocation(getProgramId(), "grey2Frame");
        mMaskGrey3UniformLocation = GLES20.glGetUniformLocation(getProgramId(), "grey3Frame");
    }
    ...
    public void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                GLES20.glActiveTexture(GLES20.GL_TEXTURE4);
                mMaskGrey1TextureId = OpenGLUtil.loadTexture(BeautyParams.context, "filter/amaro_mask1.jpg");
                GLES20.glActiveTexture(GLES20.GL_TEXTURE5);
