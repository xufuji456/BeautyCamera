...
public class BeautyWarmFilter extends GPUImageFilter {
    ...
    public void onInit() {
        ...
        mMaskGrey1UniformLocation = GLES30.glGetUniformLocation(getProgramId(), "layerImage");
        mMaskGrey2UniformLocation = GLES30.glGetUniformLocation(getProgramId(), "greyFrame");
    }
