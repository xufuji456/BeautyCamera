...
/**
 * @author xufulong
 * @date 2022/6/25 6:44 下午
 * @desc
 */
public class BeautyWarmFilter extends GPUImageFilter {
    ...
    public BeautyWarmFilter() {
        super(NORMAL_VERTEX_SHADER, OpenGLUtil.readShaderFromSource(R.raw.warm));
    }
    ...
    public void onInit() {
        ...
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(getProgramId(), "layerImage");
        mMaskGrey2UniformLocation = GLES20.glGetUniformLocation(getProgramId(), "greyFrame");
    }
