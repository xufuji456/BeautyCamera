...
public class BeautyHealthyFilter extends GPUImageFilter {
    ...
    protected void onInit() {
        ...
        mMaskGrey1UniformLocation = GLES30.glGetUniformLocation(getProgramId(), "mask");
        mTexelWidthUniformLocation = GLES30.glGetUniformLocation(getProgramId(), "texelWidthOffset");
        mTexelHeightUniformLocation = GLES30.glGetUniformLocation(getProgramId(), "texelHeightOffset");
    }
