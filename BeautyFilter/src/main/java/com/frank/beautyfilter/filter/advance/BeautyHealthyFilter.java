...
/**
 * @author xufulong
 * @date 2022/6/22 11:07 上午
 * @desc
 */
public class BeautyHealthyFilter extends GPUImageFilter {
    ...
    public BeautyHealthyFilter() {
        super(NORMAL_VERTEX_SHADER, OpenGLUtil.readShaderFromSource(R.raw.healthy));
    }
    ...
    protected void onInit() {
        ...
        mMaskGrey1UniformLocation = GLES20.glGetUniformLocation(getProgramId(), "mask");
        mTexelWidthUniformLocation = GLES20.glGetUniformLocation(getProgramId(), "texelWidthOffset");
        mTexelHeightUniformLocation = GLES20.glGetUniformLocation(getProgramId(), "texelHeightOffset");
    }
